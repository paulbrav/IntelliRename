...
def get_from_cache(cache_key: str, cache_dir: Optional[str] = None) -> Optional[Dict[str, Any]]:
    """
...
def save_to_cache(cache_key: str, data: Dict[str, Any], cache_dir: Optional[str] = None) -> bool:
    """
    Save data to cache.
